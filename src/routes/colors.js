    ...
    app.get('/v1/color-api/:color', async (req, res) => {
        ...
        res.status(200).send({
            ...
            "hydra:view": {
                ...
                "hydra:previous": `previousPage?${BASE_URI}id/color-api/${targetColor}?image=true&pageNumber=${previousPage}`,
                "hydra:next": `nextPage?${BASE_URI}id/color-api/${targetColor}?image=true&pageNumber=${nextPage}`,
